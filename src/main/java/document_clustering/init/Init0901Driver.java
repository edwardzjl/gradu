...
public class Init0901Driver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(Init0901Driver.class);
...
//        job.setNumReduceTasks(0);
        ...
        System.out.println("0901 init job finished in: " + (endtime - starttime) / 1000 + " seconds");
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.exit(ToolRunner.run(configuration, new Init0901Driver(), args));
    }
}

// End Init0901Driver.java
